...
#frame superior
frame_top = tk.Frame(root, width=1200, height=20)
...
lbl_tamanho = tk.Label(frame_left, background="#000C66")
...
lbl_rot = tk.Label(frame_left, background="#000C66")
...
btn_reforigem = tk.Button(frame_left, text="Ref Origem", command=lambda: ogl_frame.reflexaoOrigem())
...
# Botão para desenhar um quadrado
btn_desenhar_quadrado_3d = tk.Button(frame_left3d, text="Desenhar Cubo", command=lambda: ogl_frame.square_points(int(entry_tamanho.get())))
